    ...
    def _setup_messages(self) -> Dict[str, Dict]:
        ...
        return {
            MessageType.WELCOME.value: {
                "new_user": """🎉 <b>Добро пожаловать в VideoBot Pro!</b>
...
{subscription_info}""",
                ...
                "returning_user": """👋 <b>С возвращением!</b>
...
💡 Отправьте ссылку для скачивания видео!""",
                ...
                "trial_available": """🎁 <b>Пробный период доступен!</b>
...
Хотите активировать пробный период?""",
                ...
                "trial_active": """🔥 <b>Пробный период активен!</b>
...
Напишите @support_bot""",
                ...
                "formats": """📋 <b>Поддерживаемые форматы:</b>
